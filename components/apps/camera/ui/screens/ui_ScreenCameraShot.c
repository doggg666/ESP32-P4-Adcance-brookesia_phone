...
lv_obj_set_height( ui_ImageCameraShotImage, 600);
lv_obj_set_width( ui_ImageCameraShotImage, 1024);
...
lv_obj_set_y( ui_PanelCameraShotControlBg, -110 );
...
lv_obj_set_y( ui_ButtonCameraShotBtn, -120 );
...
lv_obj_set_y( ui_PanelCameraShotAlbum, -120 );
