...
bool Camera::run(void)
{
    ...
    lv_obj_align(mode_switch_btn, LV_ALIGN_TOP_RIGHT, 0, 0);
...
bool Camera::init(void)
{
    ...
    static i2c_master_bus_handle_t camera_i2c_bus_handle = NULL;
    i2c_master_bus_handle_t i2c_bus_handle = camera_i2c_bus_handle;
